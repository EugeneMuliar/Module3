 ...
 * Provides content.
 */
class ResponseAddForm extends ConfigFormBase {
  ...
  public function validateEmailFormat(array &$form, FormStateInterface $form_state) {
    return filter_var($form_state->getValue('mail'), FILTER_VALIDATE_EMAIL);
  }
